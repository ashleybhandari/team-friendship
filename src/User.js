class User {
    /**
     * Constructor: This contains an object with all user info for their housing
     * information. Parameters in brackets are optional.
     * @param {number} id
     * @param {string} email
     ...
     */
    constructor(email, pic, name, age, gender, characteristics, schooling,
