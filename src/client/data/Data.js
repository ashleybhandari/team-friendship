...
const u0 = new User(
    ...
    { fname: 'Robert', lname: 'Belcher', nname: 'Bob' },
    46,
    { identity: 'male', pronouns: 'he/him' },
    { clean: 1, sleep: 2, noise: 2, guests: 1 },
    { major: 'Culinary Arts', level: 'Undergrad' },
    null,
    null,
    new Preferences()
);
...
const u1 = new User(
    ...
    { fname: 'Linda', lname: 'Belcher', nname: 'Lin' },
    44,
    { identity: 'female' },
